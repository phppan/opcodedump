...
/* {{{ proto string confirm_opcodedump_compiled(string arg)
   Return a string to confirm that the module is compiled in */
PHP_FUNCTION(confirm_opcodedump_compiled)
{
	char *arg = NULL;
	size_t arg_len, len;
	zend_string *strg;
	...
	strg = strpprintf(0, "Congratulations! You have successfully modified ext/%.78s/config.m4. Module %.78s is now compiled into PHP.", "opcodedump", arg);
